        ...
        <div className="grid grid-cols-3 place-items-center">
          ...
          <div className="flex flex-col items-center">
            <div className="flex flex-col bg-blue-500 text-white relative justify-center items-center rounded-full w-12 h-12">
              ...
              before:content-[''] before:absolute before:w-[1000px] before:-z-10 before:top-1/2 before:h-[2px] before:-left-[920px] before:bg-blue-500
              
              after:content-[''] after:absolute after:-left-2 after:-top-2 after:w-16 after:h-16 after:-z-[1] after:rounded-full after:bg-gray-100"
              >
                3
              </p>
            </div>
      ...
      <section>
        <div className="pt-16 w-full absolute left-0 sm:bg-map bg-cover bg-no-repeat bg-center bg-blue-600 bg-opacity-25 bg-blend-overlay">
          <div className="grid grid-cols-1 sm:grid-cols-2 container pb-16 place-items-center sm:place-items-start">
            <div className="flex flex-col text-zinc-600 text-center sm:text-left pl-6">
